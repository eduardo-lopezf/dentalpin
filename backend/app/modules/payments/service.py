...
from app.core.utils.clinic_time import (
    clinic_date,
    clinic_day_window,
    clinic_midnight,
    clinic_zone,
...
#
# The helpers moved to ``app.core.utils.clinic_time`` when `cashbox` needed
# the same boundaries to decide which refunds belong to the day it counts.
# They are aliased under their old private names so the call sites below —
# and the reasoning the tests pin — stay as they were.

_clinic_zone = clinic_zone
_clinic_midnight = clinic_midnight
_clinic_day_window = clinic_day_window
_clinic_date = clinic_date
